...
public class helperTimeStop extends helperImageButton {
	private int imageID;
	private int selectedImageID;
	private boolean isSelected = false;
	private int nameID;
	public helperTimeStop(Context context,int _name) {
		super(context,_name);
		nameID = _name;
		imageID = R.drawable.aray;
		selectedImageID = R.drawable.aray_gray;
		drawImage();
	}
	@Override
