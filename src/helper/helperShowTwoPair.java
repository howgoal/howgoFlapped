...
public class helperShowTwoPair extends helperImageButton{
	private int imageID;
	private int selectedImageID;
	private boolean isSelected = false;
	private int nameID;
	public helperShowTwoPair(Context context, int _name) {
		super(context, _name);
		nameID = _name;
		imageID = R.drawable.howgo;
		selectedImageID = R.drawable.howgo_gray;
		drawImage();
	}
